...
home_odds = st.number_input("Enter Home Win Odds", min_value=0.0, step=0.01, value=2.5)
draw_odds = st.number_input("Enter Draw Odds", min_value=0.0, step=0.01, value=3.2)
away_odds = st.number_input("Enter Away Win Odds", min_value=0.0, step=0.01, value=3.0)
...
if st.button("Predict Match Outcome"):
    # Placeholder team statistics (replace these with real data)
    team_a_stats = {
        "average_goals": 1.3,
        "win_percentage": 0.73,
    }
